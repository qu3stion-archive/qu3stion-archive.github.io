...
*/
const GOOGLE_FORM_ID = "1FAIpQLSdKbRs_vMtoy9DK-psmFDG-6_x17lySUHLsCs4FoYPMzXndSw";
const ENTRY_ID = "entry.705176925";
const NAME_ID = "entry.495541318";
const GOOGLE_SHEET_ID = "1v7C2Hq9uTxww-4FhuY4HapIW7t3ygMNWxEUxdr0E-ak";
...
document.getElementById("submit").addEventListener("click", async function () {
  ...
  try {
    ...
    if(IMAGE_APPROVAL){
      alert("Image uploaded successfully! It will post once i approve the image :D");
    }
    else {
